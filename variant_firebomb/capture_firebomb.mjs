...
async function main() {
  ...
  await page.goto(`http://127.0.0.1:${port}/scene_volumetric3d.html?v=${Date.now()}`, {
  ...
  await encode(512, 'hyperlinks-space-sticker.webm', 60, '58k');
  await encode(100, 'hyperlinks-space-emoji.webm', 48, '42k');
  console.log('Done');
}
